...
\begin{figure}[h!]
  \centering
  \subfloat[Sublocal menu for Tops]{\label{fig:localMenuTops}\includegraphics[width=0.35\textwidth]{localMenuTops.png}}                
  \subfloat[Sublocal menu for Bottoms]
  {\label{fig:localMenuBottoms}\includegraphics[width=0.35\textwidth]{localMenuBottoms.png}}
  \subfloat[Sublocal menu for Footwear]{\label{fig:localMenuFootwear}\includegraphics[width=0.35\textwidth]{localMenuFootwear.png}}
